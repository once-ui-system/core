...
<Table
  ...
  rows={[
    ...
    ["App shell navigation", "7 min", "/common-patterns/app-shell-navigation.mdx"],
    ["Dashboard & charts", "8 min", "/common-patterns/dashboard-and-charts.mdx"],
    ["Chat & messaging", "7 min", "/common-patterns/chat-and-messaging.mdx"],
    ["Roadmap & kanban", "7 min", "/common-patterns/roadmap-and-kanban.mdx"],
    ["Form inputs & controls", "6 min", "/common-patterns/form-inputs-and-controls.mdx"],
    ["Progress, status & badges", "5 min", "/common-patterns/progress-status-and-badges.mdx"],
    ["Scrolling & feeds", "6 min", "/common-patterns/scrolling-and-feeds.mdx"],
  ]}
  marginBottom={2}
/>
...
<Table
  ...
  rows={[
    ...
    ["Match task bundles", "6 min", "/agent-resources/match-task-bundles.mdx"],
  ]}
  marginBottom={2}
/>
