...
export default function ComponentsCheckOld() {
  ...
  const categories: Category[] = [
    ...
    },
    {
      ...
      components: [
        ...
        },
        {
          name: "NumberInput",
          element: (
            <NumberInput id="demo-number" label="Quantity" placeholder="0" />
          ),
        },
        {
          name: "ColorInput",
          element: (
            <ColorInput id="demo-color" value="#3b82f6" onChange={() => {}} />
          ),
        },
        { name: "OTPInput", element: <OTPInput length={4} /> },
        {
          name: "Checkbox",
          element: <Checkbox label="Accept terms and conditions" />,
        },
        {
          name: "Switch",
          element: (
    ...
    },
    {
      ...
      components: [
        ...
        {
          name: "Toaster",
          element: <Button onClick={() => handleAddToast()}>Show Toast</Button>,
        },
      ],
    },
    {
      ...
      components: [
        {
          ...
          element: (
            <Accordion title="What is Once UI?">
              <Text>
                A design system and component library for Next.js applications.
              </Text>
            </Accordion>
          ),
        },
            ...
            <AccordionGroup
              items={[
                ...
                },
                {
                  title: "Configuration",
                  content: (
                    <Text>Edit once-ui.config.js to customize the theme.</Text>
                  ),
                },
                {
                  title: "Components",
                  content: (
                    <Text>Import components from @once-ui-system/core.</Text>
                  ),
                },
              ]}
            />
        ...
        },
        {
          ...
          element: (
            <Card padding="l" radius="l" fillWidth>
              <Text>A simple card component</Text>
            </Card>
          ),
        },
        {
