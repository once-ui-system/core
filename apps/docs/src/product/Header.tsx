        ...
        >
          <Row fillWidth vertical="center" gap="8">
            ...
            <Row vertical="end" gap="8">
              ...
              <Logo
                light
                wordmark="/trademarks/type-light.svg"
                size="s"
                href="/"
              />
              <Text onBackground="neutral-weak" marginBottom="1">
                Docs
              </Text>
            </Row>
          </Row>
          ...
          <Row
            ...
            vertical="center"
          >
            <ThemeSwitcher style={{ scale: 0.85 }} />
            <Line vert height="20" marginRight="8" />
