...
<Row fillWidth vertical="end" gap="12">
  <Avatar size="s" src="/images/avatar.jpg" marginBottom="20"/>
  <Row fillWidth padding="20" marginY="20" background="surface" border="neutral-alpha-weak" borderStyle="dashed" radius="l">get-library-docs /once-ui-system/mcp</Row>
</Row>
...
<Row fillWidth vertical="end" gap="12">
  <Avatar size="s" src="/images/avatar.jpg" marginBottom="20"/>
  <Row fillWidth padding="20" marginY="20" background="surface" border="neutral-alpha-weak" borderStyle="dashed" radius="l">I want you to implement [...]. use context7</Row>
</Row>
