...
**Used in components:** [Input](/components/input), [Textarea](/components/textarea) (for character count updates), [EmojiPicker](/components/emoji-picker) (for search filtering)
