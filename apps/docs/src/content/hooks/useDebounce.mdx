...
**Used in components:** [Input](/form-controls/input), [Textarea](/form-controls/textarea) (for character count updates), [EmojiPicker](/components/emojiPicker) (for search filtering)
