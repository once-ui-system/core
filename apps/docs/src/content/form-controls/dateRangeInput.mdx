...
docs: "once-ui/form-controls/dateRangeInput.mdx"
...
<PropsTable
  ...
  describe={{
    id: "Ties the labels to the fields.",
    startLabel: "Label on the start field.",
    endLabel: "Label on the end field.",
    value: "The range, as start and end.",
    onChange: "Called with the new range.",
    minHeight: "Lower bound on the picker's height, in rem.",
  }}
  content={[
    ["className"],
    ["style"]
