...
<PropsTable
  ...
  describe={{
    value: "The current colour, as hex or rgba. Controlled — pair it with onChange.",
    onChange: "Receives the colour string directly, not a DOM event.",
    supportAlpha: "Adds an opacity slider and switches the value to rgba().",
  }}
/>