...
<Grid marginBottom="48" fillWidth gap="1" columns="4" s={{columns: 2}} radius="l" overflow="hidden">
  {[
...
<Grid marginBottom="16" gap="1" columns="6" s={{columns: 2}} m={{columns: 3}} radius="l" overflow="hidden">
  {[
