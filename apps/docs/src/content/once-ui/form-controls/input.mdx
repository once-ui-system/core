...
<CodeBlock
  ...
  preview={
    <Column fillWidth gap="16">
      <Input id="size-xs" label="Extra Small" height="xs" />
      <Input id="size-s" label="Small" height="s" />
      <Input id="size-m" label="Medium" height="m" />
      <Input id="size-l" label="Large" height="l" />
      <Input id="size-xl" label="Extra Large" height="xl" />
    </Column>
  }
  codes={[
    {
      code:
`<Input placeholder="Extra Small" height="xs" />
<Input placeholder="Small" height="s" />
<Input placeholder="Medium" height="m" />
<Input placeholder="Large" height="l" />
<Input placeholder="Extra Large" height="xl" />`,
      language: "tsx",
      label: "Sizes"
    }
  ]}
