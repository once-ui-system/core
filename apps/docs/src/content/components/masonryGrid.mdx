...
<PropsTable
  ...
  describe={{
    children: "The items. Each keeps its own height.",
    columns: "How many columns.",
    gap: "Space between items.",
    l: "Column count at the l breakpoint and below.",
    m: "Column count at the m breakpoint and below.",
    s: "Column count at the s breakpoint and below.",
    xs: "Column count at the xs breakpoint.",
  }}
  content={[
    ["className"],
    ["style"],
