        ...
        tasks: [
          {
            ...
            description:
              "Make stylepanel composable and add additional edit options like custom colors.",
            type: "feature",
          },
          {
            title: "Chart states",
        ...
        tasks: [
          {
            title: "Hot reload",
            description:
              "Automatically re-render documentation when changes are detected in MDX files.",
            type: "feature",
          },
          {
            title: "Versioning",
