...
const navigation = [
  ...
  },
  {
    title: "Pro",
    items: [
      { label: "Orbit Core", href: "#", tag: "New" },
      { label: "Stack", href: "#", tag: "New" },
  ...
  return (
    <Column fillWidth horizontal="center" {...flex}>
      ...
      <Row fillWidth horizontal="center">
        ...
        <Column maxWidth="xl" borderX="neutral-alpha-medium">
          <Row
            paddingX="xl"
            paddingTop="xl"
            paddingBottom="40"
          ...
          <Row paddingX="xl" paddingBottom="xl" fillWidth wrap gap="32" horizontal="between">
            {navigation.map((section) => (
              <Column key={section.title} maxWidth={12} gap="32" paddingY="8">
                ...
                {[
                  ...
                  const arr = (section as Record<string, unknown>)[key] as
                    | Array<{ label: string; href: string; tag?: string }>
                    | undefined;
